...
class ForeignKeyColumn(BaseModel):
    ...
    referenced_column: str = Field(..., description="The name of the referenced column in the foreign table.")
...
class ForeignKeySchema(BaseModel):
    ...
    columns: List[ForeignKeyColumn] = Field(default_factory=list, description="List of columns forming the foreign key.")
